...
public class UsrReactionPointController {
  ...
  String doBadReaction(String relTypeCode, int relId, String replaceUri) {
    ResultData actorCanMakeReactionPointRq = reactionPointService.actorCanMakeReactionPoint(rq.getLoginedMemberId(), relTypeCode, relId);

    if(actorCanMakeReactionPointRq.isFail()) {
      return rq.jsHistoryBack(actorCanMakeReactionPointRq.getMsg());
    }
