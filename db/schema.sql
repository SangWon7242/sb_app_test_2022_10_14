...
CREATE TABLE reactionPoint(
	...
	relTypeCode CHAR(30) NOT NULL COMMENT '관련테이터타입코드',
	relId INT(10) UNSIGNED NOT NULL COMMENT '관련테이터번호',
...
# 게시물 테이블 goodReactionPonint 칼럼을 추가
ALTER TABLE article
ADD COLUMN goodReactionPoint INT(10) UNSIGNED NOT NULL DEFAULT 0;

# 게시물 테이블 badReactionPonint 칼럼을 추가
ALTER TABLE article
...
# 기존 게시물의 goodReactionPonint 필드의 값 채우기
UPDATE article AS A
INNER JOIN (
	SELECT RP.relId,
	SUM(IF(RP.point > 0, RP.point, 0)) AS goodReactionPoint,
